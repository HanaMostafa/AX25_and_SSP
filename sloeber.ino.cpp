...
//This file has been generated on 2022-04-26 17:58:16
...
void ssp_ax_deframing(uint8 *Control_To_SSP, uint8 *ax_dest, uint8 *ax_src, uint8 *ax_type,                    uint8 *ax_rx_data, uint16 *ax_rx_length, uint8 *deframe_ax_flag) ;
void ax_ssp_framing(uint8 *ax_ssp_frame, uint8 *Rx_App_data, uint8 desti, uint8 srce,                      uint8 typee, uint16 Rx_length, uint16 *tx_ax_length,uint8 *ax_ssp_flag) ;
